...
-- Nada aqui pergunta de quem é o lançamento: é pró-labore dos sócios, pago de
-- forma aglutinada, e o sigilo vem do CC da diretoria. A pergunta é de
-- amarração: as duas contas estão no MESMO master e com sinais que se anulem?
-- Se só um lado estiver amarrado, a linha da DRE infla ±272 mil.
-- razao_dre já vem com o sinal da amarração aplicado.
